...
const ProjectsSection = ({ isVisible, activeProject, setActiveProject }) => (
...
const Portfolio = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      ...
      <ProjectsSection isVisible={isVisible} activeProject={activeProject} setActiveProject={setActiveProject} />
