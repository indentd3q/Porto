...
const Header = () => {
  ...
  return (
    <header className="flex justify-between items-center py-4 bg-gray-800 text-white">
      <nav className={`flex justify-between items-center ${menuOpen ? 'block' : 'hidden'} md:flex`}>
      ...
      <button 
        className="mobile-nav-button bg-gray-800 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded md:hidden"
        onClick={toggleMenu}
      >
